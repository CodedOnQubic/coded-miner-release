...
coded_m1091p055_activate_macos_beta_bpp9000() {
  ...
  # M1091P059_PUBLIC_RELEASE_TASK_AUTHORITY
  #
  # coded-miner is private and is not a runtime transport authority.
  # The canonical BPP9000 task is published in coded-miner-release
  # and pinned to an immutable public release-repository commit.
  # Integrity remains fail-closed under expected_task_sha.
  task_release_commit="9d7475ee2a9b5e6f0a520e9ce7251ed954811756"
  ...
  if [ ! -f "$task_file" ]; then
    ...
    task_url="https://raw.githubusercontent.com/CodedOnQubic/coded-miner-release/${task_release_commit}/runtime/anthill/task_bpp9000.bin"
    ...
    then
      ...
      echo \
        "ERROR macos_anthill activation denied reason=task_download_failed task_release_commit=$task_release_commit miner_release_commit=${source_commit:-missing}"
...
PYN
  ...
  export CODED_ANTHILL_SOLUTION_THRESHOLD="3838"
